...
if(isset($_POST['save_student']))
{
    ...
    if($name == NULL || $npm == NULL || $phone == NULL || $prodi == NULL || $nominal == NULL || $tgl == NULL)
    {
        $res = [
            'status' => 422,
    ...
    $query = "INSERT INTO students (name,npm,phone,prodi,nominal,tgl) VALUES ('$name','$npm','$phone','$prodi','$nominal','$tgl')";
...
if(isset($_POST['update_student']))
{
    ...
    $query = "UPDATE students SET name='$name', npm='$npm', phone='$phone', prodi='$prodi' , nominal='$nominal' , tgl='$tgl'
                WHERE id='$student_id'";
    $query_run = mysqli_query($con, $query);
